package kotlin2021.list

class MyList(vararg elems: String, limit: Int = 1000) : java.util.List<String> {

    private val data = Array(limit) {
            ind -> if (ind < elems.size) elems[ind] else ""
    }
    ...
    override fun toString(): String= data.take(size).joinToString(prefix="[", postfix="]", limit = 1)

}

fun MyList.lastind() = this.size - 1

fun main(args: Array<String>) {
    println(MyList("alfa", "beta")[1]);
}
